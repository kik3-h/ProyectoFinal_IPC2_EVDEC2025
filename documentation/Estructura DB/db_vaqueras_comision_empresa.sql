...
--
-- Table structure for table `comision_empresa`
--
...
CREATE TABLE `comision_empresa` (
  ...
  KEY `fk_ce_empresa` (`id_empresa`),
  CONSTRAINT `fk_ce_empresa` FOREIGN KEY (`id_empresa`) REFERENCES `empresa` (`id_empresa`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `comision_empresa`
--

LOCK TABLES `comision_empresa` WRITE;
/*!40000 ALTER TABLE `comision_empresa` DISABLE KEYS */;
INSERT INTO `comision_empresa` VALUES (1,1,10.00,'2025-12-29 02:40:18'),(2,4,13.00,'2026-01-02 02:39:01');
/*!40000 ALTER TABLE `comision_empresa` ENABLE KEYS */;
UNLOCK TABLES;
